    ...
    <main class="main-content" style="flex: 1; display: flex; flex-direction: column; justify-content: space-between; padding: 30px; box-sizing: border-box;">
        ...
        <div>
            ...
            <div class="header-bar" style="margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
                <div>
                    <h2><i class="fas fa-user-graduate" style="color: var(--primary);"></i> My Students Roster</h2>
                    <span style="color: var(--text-muted); font-size: 13.5px;">All enrolled students across every training cohort assigned under your mentorship.</span>
                </div>
                ...
                <div class="card-header-custom" style="margin-bottom: 18px; border-bottom: 1px solid var(--border); padding-bottom: 12px; display: flex; align-items: center; justify-content: space-between;">
                    <div>
                        <h6 style="margin: 0; font-size: 16px; color: var(--text); font-weight: 700;">
                            <i class="fas fa-users" style="color: var(--primary); margin-right: 6px;"></i> Total Active Students
                        </h6>
                        <small style="color: var(--text-muted); font-size: 12.5px;">Verified profiles and contact information</small>
                    </div>
                    <span class="badge badge-approved" style="font-size: 12px; font-weight: 600;">
                        ${fn:length(students)} Registered
                    </span>
                </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-user" style="color: var(--primary); margin-right: 6px;"></i> Full Name</th>
                                ...
                                <th><i class="fas fa-phone-alt" style="color: var(--primary); margin-right: 6px;"></i> Contact Number</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <tr>
                                        <td colspan="5" style="text-align: center; padding: 36px; color: var(--text-muted);">
                                            ...
                                            <p style="margin: 4px 0 0; font-size: 13px;">No students are assigned to your batches yet. Contact the administrator to assign batches.</p>
                                        </td>
                                    </tr>
                                </c:otherwise>
                            </c:choose>
