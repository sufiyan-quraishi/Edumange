...
<div class="sidebar">
    ...
    <!-- Brand Header Fixed: Icon Left + Text & Badge Stacked Right -->
    <div class="sidebar-header" style="padding: 16px 14px 18px 14px; border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
        <a href="${pageContext.request.contextPath}/student/dashboard" style="text-decoration: none; display: flex; align-items: center; gap: 12px;">
            <!-- Logo Icon -->
            <div style="width: 38px; height: 38px; border-radius: 10px; background: #4f6ef7; display: flex; align-items: center; justify-content: center; color: #ffffff; font-size: 20px; flex-shrink: 0;">
                <i class="fas fa-graduation-cap"></i>
            </div>
            <!-- Name & Portal Badge in one neat block -->
            <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 2px;">
                ...
                <span class="badge badge-approved" style="font-size: 9.5px; padding: 2px 7px; font-weight: 700; border-radius: 4px; line-height: 1.2;">STUDENT PORTAL</span>
            </div>
        </a>
    </div>
    ...
    <div class="sidebar-menu" style="padding-top: 10px;">
        ...
        <a href="${pageContext.request.contextPath}/student/tasks" class="sidebar-link">
        ...
        <a href="${pageContext.request.contextPath}/student/feedback" class="sidebar-link">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    // 1. Active Tab Detector
    const currentPath = window.location.pathname;
    const links = document.querySelectorAll('.sidebar .sidebar-link');

    links.forEach(link => {
      const href = link.getAttribute('href');
      if (href && currentPath.endsWith(href) && !href.includes('/logout')) {
