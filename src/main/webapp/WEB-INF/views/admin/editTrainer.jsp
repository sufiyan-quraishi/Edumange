...
<div class="dashboard-layout">
    ...
    <main class="main-content">
        ...
        <div class="header-bar" style="margin-bottom: 24px;">
            <div>
                <h2><i class="fas fa-user-tie" style="color: var(--primary);"></i> Edit Trainer Profile</h2>
                <span style="color: var(--text-muted); font-size: 13.5px;">Update instructor credentials, contact details, and faculty account status.</span>
            </div>
                ...
                <div style="margin-bottom: 24px; border-bottom: 1px solid var(--border); padding-bottom: 14px; display: flex; align-items: center; justify-content: space-between;">
                    <div>
                        <h5 style="margin: 0 0 4px 0; font-size: 18px; color: var(--text); font-weight: 700;">
                            <i class="fas fa-chalkboard-teacher" style="color: var(--primary); margin-right: 6px;"></i> Faculty Account Details
                        </h5>
                        <small style="color: var(--text-muted); font-size: 13px;">Editing instructor: <strong>${trainer.fullName}</strong></small>
                    </div>
                    <span class="badge ${trainer.active ? 'badge-approved' : 'badge-pending'}" style="font-size: 12px;">
                        ${trainer.active ? 'Active Faculty' : 'Inactive Faculty'}
                    </span>
                </div>

                <!-- Unchanged Form Logic & Action -->
                <form action="${pageContext.request.contextPath}/admin/trainers/${trainer.id}/update" method="post">
                    ...
                    <div class="form-group" style="margin-bottom: 18px;">
                        ...
                        <input type="text" name="fullName" value="${trainer.fullName}" required style="width: 100%; box-sizing: border-box;">
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 18px;">
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="email" name="email" value="${trainer.email}" style="width: 100%; box-sizing: border-box;">
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="text" name="phone" value="${trainer.phone}" style="width: 100%; box-sizing: border-box;">
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 18px;">
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="text" name="username" value="${trainer.username}" required style="width: 100%; box-sizing: border-box;">
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <select name="active" style="width: 100%; box-sizing: border-box; padding: 10.5px 12px; border-radius: 10px; border: 1px solid var(--border); background: var(--surface); color: var(--text); font-size: 13.5px;">
                                <option value="true" ${trainer.active ? "selected" : ""}>Active</option>
                                <option value="false" ${!trainer.active ? "selected" : ""}>Inactive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 14px; align-items: center;">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/trainers" class="btn-secondary" style="padding: 12px 20px; font-size: 14px; font-weight: 600; border-radius: 10px; text-decoration: none; display: inline-flex; align-items: center; justify-content: center;">
                            Cancel
                        </a>
                    </div>
